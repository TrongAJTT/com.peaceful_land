...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Bảng lưu trữ thông tin tài khoản';
...
INSERT INTO `accounts` VALUES (4,2,'dangvantrong2004@gmail.com','123@',346000,'Trọng Đặng','2004-10-04','0123123124','template/blank_avatar.webp',_binary '','2025-01-05','',_binary '\0',0,'2024-12-06 03:49:43');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Bảng lưu trữ nhật ký cập nhật bài đăng. Bài đăng khi được chỉnh sửa thì phải thêm vào đây trước sau đó mới cập nhật bảng Posts.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `post_logs` VALUES (3,3,'Chủ cần bán gấp lô đất ở An Tịnh, Trảng Bàng 220m2 full TC giá chỉ 470tr',_binary '','Bán lô đất 220m tại đường Bầu Suối Sâu, An Tịnh, Trảng Bàng chỉ 470 triệu.','2024-12-16','post_thumbns/bf9915bb-0a22-44d9-9f45-464a4733b7bc_images3.jpg','',_binary '\0',0,'2024-12-06 03:53:53');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Bảng lưu trữ thông tin bài đăng mới nhất';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `posts` VALUES (3,9,'Chủ cần bán gấp lô đất ở An Tịnh, Trảng Bàng 220m2 full TC giá chỉ 470tr',_binary '','Bán lô đất 220m tại đường Bầu Suối Sâu, An Tịnh, Trảng Bàng chỉ 470 triệu.','post_thumbns/bf9915bb-0a22-44d9-9f45-464a4733b7bc_images3.jpg','2024-12-16','',_binary '\0',0,'2024-12-06 03:53:53');
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Bảng cập nhật thông tin mới nhất về bất động sản.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `properties` VALUES (9,4,_binary '\0',_binary '',NULL,'Thành phố Hồ Chí Minh, Quận 7, Phường Tân Phong','12, Huỳnh Tấn Phát','Google Map Url Example','Nhà riêng',230000000,40,'Sổ hồng',2,2,0,0,NULL,NULL,_binary '','',0,'2024-12-06 03:51:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Bảng lưu trữ tập tin và đường dẫn';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `property_images` VALUES (8,9,'property_imgs/572c4a88-4dea-47f0-b5aa-f39677d3c309_images3.jpg');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Bảng ghi lại nhật ký cập nhật bất động sản, khi cập nhật cần thêm dữ liệu vào bảng này trước.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `property_logs` VALUES (8,9,'Cập nhật giá',_binary '\0',_binary '',NULL,230000000,'',_binary '\0',0,'2024-12-06 03:51:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Bảng ghi lại những lần thanh toán trên trang web.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `purchases` VALUES (3,4,154000,'Mua gói môi giới VIP','',_binary '\0',0,'2024-12-06 03:50:17');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Bảng chứa thông tin yêu cầu duyệt bài rao và bất động sản';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `requests_post` VALUES (8,3,'2024-12-07',_binary '\0','Bài rao vi phạm tiêu chuẩn rao bài','',_binary '\0',0,'2024-12-06 08:01:30');
...
INSERT INTO `user_interests` VALUES (6,4,9,_binary '',_binary '','',_binary '\0',0,'2024-12-07 12:49:54');
...
-- Dump completed on 2024-12-08 10:36:52
